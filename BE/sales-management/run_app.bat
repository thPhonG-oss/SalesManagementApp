...
set "SECRET_KEY=5367566B59703373367639792F423F4528482B4D6251655468576D5A71347437"

:: 4. CAU HINH CLOUDINARY (Upload anh)
set "CLOUD_NAME=drv53xdea"
set "CLOUD_API_KEY=543496999514893"
set "CLOUD_API_SECRET=9i4lvv0cGHnDyFtkZIJOhDVBQF8"
